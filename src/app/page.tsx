...
import { Briefcase, Check, Trash2, LogOut, Star, Edit2, Repeat, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem]">
      ...
      <motion.div
        ...
        className={`group flex flex-col bg-white p-5 rounded-[2rem] border border-gray-50 shadow-sm hover:shadow-xl hover:shadow-purple-500/5 transition-all duration-300 cursor-grab active:cursor-grabbing relative z-10 ${isExpanded ? 'ring-2 ring-purple-100' : ''}`}
      >
          ...
          <div className="flex items-center gap-2">
            ...
            {!task.completed && (
              <button 
                ...
                className="w-9 h-9 rounded-full bg-blue-50 flex items-center justify-center text-blue-300 hover:text-blue-500 hover:bg-blue-100 transition-all"
              >
            ...
            <button 
              ...
              className="w-9 h-9 rounded-full bg-red-50 flex items-center justify-center text-red-300 hover:text-red-500 hover:bg-red-100 transition-all"
            >
          ...
          <div className="mt-3 w-full">
            <div className="flex items-center justify-between text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5 px-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <ChevronDown size={14} className={`transition-transform duration-300 ${isExpanded ? 'rotate-180 text-purple-600' : ''}`} />
              </div>
            </div>
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              className="overflow-hidden w-full border-t border-slate-50 pt-4"
              onClick={(e) => e.stopPropagation()}
            >
              <SubTaskList 
                taskId={task.id!} 
                compact 
                onProgressChange={() => onRefresh()} 
              />
            </motion.div>
          )}
        </AnimatePresence>
